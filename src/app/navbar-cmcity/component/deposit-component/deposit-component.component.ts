...
export class DepositComponentComponent implements OnInit {
  ...
  documents = [
    {
      label: 'คู่มือปฏิบัติงานกองทุนฯ',
      path: '/assets/pdf/คู่มือปฏิบัติงานกองทุนฯ.pdf',
    },
    {
      label: 'ใบสมัครเข้าเป็นสมาชิก',
      path: '/assets/pdf/ใบสมัครเข้าเป็นสมาชิก.pdf',
    },
    { label: 'หนังสือขอลาออก', path: '/assets/pdf/หนังสือขอลาออก.pdf' },
    {
      label: 'หนังสือสัญญากู้กองทุนสวัสดิการ',
      path: '/assets/pdf/หนังสือสัญญากู้กองทุนสวัสดิการv2.pdf',
    },
    {
      label: 'หนังสือค้ำประกันเงินกู้กองทุนสวัสดิการ',
      path: '/assets/pdf/หนังสือค้ำประกันเงินกู้กองทุนสวัสดิการ.pdf',
    },
    {
      label: 'หนังสือขอเปลี่ยนแปลงการใช้หุ้นค้ำประกัน',
      path: '/assets/pdf/หนังสือขอเปลี่ยนแปลงการใช้หุ้นค้ำประกัน.pdf',
    },
    {
      label: 'หนังสือขอเปลี่ยนผู้ค้ำประกัน',
      path: '/assets/pdf/หนังสือขอเปลี่ยนผู้ค้ำประกัน.pdf',
    },
    {
      label: 'หนังสือขอรับเงินช่วยสมาชิกที่เกษียณ',
      path: '/assets/pdf/หนังสือขอรับเงินช่วยสมาชิกที่เกษียณv2.pdf',
    },
